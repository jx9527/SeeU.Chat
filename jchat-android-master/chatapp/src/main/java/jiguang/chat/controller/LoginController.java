    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_login:
                ...
                if(SharePreferenceManager.getCachedSign() == 0){
                    HttpConnect.sendRequestSignsWithOkHttp();
                    SharePreferenceManager.setCachedSign(1);
                }
                ...
                if (JGApplication.registerOrLogin % 2 == 1) {
                    ...
                    final Dialog dialog = DialogCreator.createLoadingDialog(mContext,
                            mContext.getString(R.string.registering_hint));
                    dialog.show();
