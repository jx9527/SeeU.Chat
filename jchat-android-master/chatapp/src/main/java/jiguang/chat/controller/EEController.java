...
public class EEController implements View.OnClickListener {

    private EEFragment mContext;
    private EEView mEEView;
    public EEController(EEFragment context, EEView aaView){
        this.mEEView = aaView;
    ...
    public void onClick(View v){
        switch (v.getId()){
            case R.id.btn_ee:
                ...
                String title = mEEView.getPipeiNameEE();
                ...
                intent.putExtra("matchString",mEEView.getPipeiString());
