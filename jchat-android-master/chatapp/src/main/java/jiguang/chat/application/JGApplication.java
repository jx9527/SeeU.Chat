...
public class JGApplication extends com.activeandroid.app.Application {
    ...
    public static long registerOrLogin = 0;
    ...
    public  static int mySignId;
    public static char pageChoose;
    ...
    //保存相似的句子的数组
    public static ArrayList<matchSignsBean> matchSignsBeans = new ArrayList<>();

    //拿到的相似的句子数量不够，需要随即拉取的标准
