...
import jiguang.chat.utils.citychoose.view.adapter.AbstractWheelAdapter;
...
public class SharePreferenceManager {
    ...
    private static  final String HeartChoose = "heart";

    public static  void setCachedHeartChoose(boolean is){
        if (null != sp){
            sp.edit().putBoolean(HeartChoose,is).apply();
        }
    }
    public static boolean getCachedHeartChoose(){
        if (null!=sp){
            return sp.getBoolean(HeartChoose,false);
        }
        return false;
    }
    ...
    public static  void setCachedRefresh(int is){
        if (null != sp){
            sp.edit().putInt(REFRESH,is).apply();
        }
    }
    public static int  getCachedRefresh(){
        if (null!=sp){
    ...
    public static  void setCachedSeed(int seed){
        if (null != sp){
            sp.edit().putInt(SEED,seed).apply();
        }
    }
    public static int getCachedSeed(){
        if (null!=sp){
            return sp.getInt(SEED,0);
        }
        return 0;
    }
    ...
    public static void  setCachedLaunch(int launch){
        if(null != sp){
            sp.edit().putInt(Launch,launch).apply();
        }
    }
    public static int getCachedLaunch(){
        if(null != sp){
            return sp.getInt(Launch,0);
        }
        return  0;
    }
    private static final String Permission = "permission";
    public static void setCachedPermission(int permission){
        if(null != sp){
            sp.edit().putInt(Permission,permission).apply();
        }
    }
    public static  int getCachedPermission(){
        if(null != sp){
    ...
    public static void setCachedSign(int getsign){
        if(null != sp){
            sp.edit().putInt(getSign,getsign).apply();
        }
    }
    public static int getCachedSign(){
        if(null != sp){
            return sp.getInt(getSign,0);
        }
        return 0;
    }
    ...
    public static void setCachedUser(int i){
        if(null != sp){
            sp.edit().putInt(getUser,i).apply();
        }
    }
    public  static int getCacheUser(){
        if(null != sp){
            return sp.getInt(getUser,0);
        }
        return 0;
    }
}
