        ...
        switch (v.getId()) {
            case R.id.login_userName:
                if (hasFocus) {
                    ...
                    mUserLine.setBackgroundColor(getResources().getColor(R.color.province_line_border));
                } else {
            ...
            case R.id.login_passWord:
                if (hasFocus) {
                    ...
                    mPswLine.setBackgroundColor(getResources().getColor(R.color.province_line_border));
                } else {
