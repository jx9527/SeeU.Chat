...
public class DDView extends LinearLayout {
    ...
    public DDView(Context context, AttributeSet attrs){
        super(context,attrs);
        this.mContext = context;
    }
    public void initModule(){
        mLeftSign = findViewById(R.id.left_msg_2d);
        mUserName = findViewById(R.id.userId_2d);
        mRightSign = findViewById(R.id.right_msg_2d);
        mPipeiName = findViewById(R.id.pipeiname_2d);
        mButton = findViewById(R.id.btn_dd);
    ...
    public void setListenerDD(OnClickListener onClickListener){
        mButton.setOnClickListener(onClickListener);
    }
    public String  getPipeiNameDD(){
