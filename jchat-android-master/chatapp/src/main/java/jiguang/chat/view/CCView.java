...
public class CCView extends LinearLayout {
    ...
    public void initModule(){
        mLeftSign = findViewById(R.id.left_msg_2c);
        mRightSign =  findViewById(R.id.right_msg_2c);
        mPipeiName =  findViewById(R.id.pipeiname_2c);
        mUserName = findViewById(R.id.userId_2c);
        mButton = findViewById(R.id.btn_cc);
    ...
    public void setListenerCC(OnClickListener onClickListener){
        mButton.setOnClickListener(onClickListener);
    }
    public String  getPipeiNameCC(){
